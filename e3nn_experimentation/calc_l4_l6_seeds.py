...
if __name__ == "__main__":
    ...
    seeds = compute_seeds_from_quaternions(fcc_syms, device="cuda" if torch.cuda.is_available() else "cpu")
    ...
    print(f"L=4 Center (m=0): {s4[4]:.4f}  (Old code used: {math.sqrt(5/24):.4f} vs {math.sqrt(7/12):.4f})")
