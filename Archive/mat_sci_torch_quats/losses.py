import torch
from quats import rand_quats, outer_prod, rot_dist, scalar_first2last, scalar_last2first
from rot_dist_approx import RotDistLoss
...
class Edge_Loss:
    ...
    def __str__(self):
        return (
            f"Dist -> dist_func: {self.dist_func}, " + f"syms: {self.syms is not None}"
        )
