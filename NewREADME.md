...
cd /home/warren/projects/Reynolds-QSR && source ~/anaconda3/etc/profile.d/conda.sh && conda activate sym-QSR && python scripts/debug_autoencoder_viz.py --exp_dir experiments/IN718/debug_x4 --config config.json --checkpoint last --split test --sample_idx 0
