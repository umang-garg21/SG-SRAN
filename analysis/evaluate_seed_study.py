...
SR = "experiments/IN718/seed_runs"
MODELS = ["edsr", "qedsr", "qrbsa", "han", "rcan", "san", "ocrp", "atindama"]
SEEDS = [42, 43, 44, 45, 46]
LABEL = {"edsr":"EDSR","qedsr":"QEDSR","qrbsa":"Q-RBSA","han":"HAN(lr1e-4)","rcan":"RCAN","san":"SAN","ocrp":"OCRP","atindama":"Atindama"}
...
# write per-seed csv
PS=ROOT/"analysis/out/seed_study_in718_4x4_per_seed.csv"
...
AGG=ROOT/"analysis/out/seed_study_in718_4x4_summary.csv"
...
print("\n===== IN718 4x4 over 5 seeds (mean +/- std, n=147 each) =====")
