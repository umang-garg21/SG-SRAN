...
if __name__ == "__main__":
    ...
    print("\nNon-overlapping SR")
    net_clean = QuaternionSRNet(base_q_channels=32, scale_factor=scale, overlap=False)
    ...
    print("\nOverlapping SR")
    net_overlap = QuaternionSRNet(base_q_channels=64, scale_factor=scale, overlap=True)
