...
class IsoEmbeddingSRSDF(nn.Module):
    """
      ...
      LR quats
        -> encoder.forward_a1
                -> equivariant LR blocks
        -> pairwise irrep evidence tensor
        -> scalar boundary/SDF head
                -> shifted irrep upsampler (optionally center-seeded by grain attention)
    ...
    def __init__(
        ...
        # Compact variant intentionally skips HR cleanup blocks and refinement.
