...
class Reynolds_quaternion_res_srnet(nn.Module):
    def __init__(self, args):
        super().__init__()
        self.model = Quaternion_res_SRNet(args)

    def forward(self, x):
        return EquivariantReynoldsWrap(
            self.model,
            self.model.group_tensor,
            self.model.group_tensor_inv
        )(x)
