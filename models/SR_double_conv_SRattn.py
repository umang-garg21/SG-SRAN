...
try:
	from models.SR_conv import (
		LocalIsoFCCEncoder as _LocalIsoFCCEncoder,
		FastLookupLocalIsoFCCDecoder as _FastLookupLocalIsoFCCDecoder,
		EquivariantSpatialConv as _LocalIsoSpatialConv,
		EquivariantTransposeConv as _LocalIsoTransposeConv,
	)
except Exception:
	from SR_conv import (  # type: ignore
		LocalIsoFCCEncoder as _LocalIsoFCCEncoder,
		FastLookupLocalIsoFCCDecoder as _FastLookupLocalIsoFCCDecoder,
		EquivariantSpatialConv as _LocalIsoSpatialConv,
		EquivariantTransposeConv as _LocalIsoTransposeConv,
